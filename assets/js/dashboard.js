...
(function($) {
    ...
    $(document).ready(function() {
        ...
        d3.json('http://104.197.142.33/json/min_sales_chart.json', function(data) {
        ...
        $('.widget-13-map').mapplic({
            source: 'http://104.197.142.33/json/dashboard-map.json',
            height: 465,
            sidebar: false,
            minimap: false,
            locations: true,
        ...
        //NVD3 Charts
        d3.json('http://104.197.142.33/json/charts.json', function(data) {
